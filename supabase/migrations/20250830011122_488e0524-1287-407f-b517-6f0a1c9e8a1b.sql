-- Security Fix: Separate banking information from profiles table
-- Create dedicated banking_details table for sensitive financial data
...
-- Clean up problematic RLS policies on profiles
...
-- Drop the problematic safe_participant_profiles view and function
DROP VIEW IF EXISTS public.safe_participant_profiles;
DROP FUNCTION IF EXISTS public.can_access_banking_info(uuid);