-- Security Fix: Drop dependent objects first, then separate banking information
-- Drop the problematic safe_participant_profiles view and function that depend on banking columns
